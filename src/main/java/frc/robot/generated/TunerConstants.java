...
import frc.robot.subsystems.swerve.SwerveIODrivetrain;
...
public class TunerConstants {
  ...
  private static final double kDriveGearRatio = (50.0 / 16.0) * (16.0 / 28.0) * (45.0 / 15.0);
  private static final double kSteerGearRatio = 150.0 / 7.0;
  private static final Distance kWheelRadius = Inches.of(1.866);

  private static final boolean kInvertLeftSide = false;
  private static final boolean kInvertRightSide = true;

  private static final CANBus kCANBus = new CANBus("");
  ...
  /**
   * Creates a SwerveIODrivetrain instance. This should only be called once in your robot program,.
   */
  public static SwerveIODrivetrain createDrivetrain() {
    return new SwerveIODrivetrain(DrivetrainConstants, FrontLeft, FrontRight, BackLeft, BackRight);
  }
}
