...
public class elevatorsub extends SubsystemBase {
  ...
  public elevatorsub() {
    slot0.kG = 0.28; // A gear ratio of 4:1 results in 0.25 output
    slot0.kS = 0.25;
    slot0.kV = 0.39; // A velocity target of 1 rps results in 0.12 V output
    ...
    slot0.kI = 0.18; // no output for integrated error
