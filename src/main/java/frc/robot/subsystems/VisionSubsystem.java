...
//   private static final TunableOption optUpdateVisionDashboard =
//       new TunableOption("Update vision dashboard", false);

//   public VisionSubsystem() {
//     assert (instance == null);
//     instance = this;

//     camera = new PhotonCamera("Frontleft");

//     kTagLayout = AprilTagFieldLayout.loadField(AprilTagFields.k2025ReefscapeAndyMark);

//     photonEstimator =
//         new PhotonPoseEstimator(
//             kTagLayout, PoseStrategy.MULTI_TAG_PNP_ON_COPROCESSOR, Constants.Vision.robotToCam);
...
//                           robotPose
//                               .estimatedPose
//                               .plus(Constants.Vision.robotToCam)
//                               .plus(tgt.getBestCameraToTarget()))
//                   .toArray(size -> new Pose3d[size]));
//       // DogLog.log("Vision/Pose Difference",
//       //
// PoseSubsystem.getInstance().getPose().getTranslation().getDistance(lastPose.getTranslation()));
